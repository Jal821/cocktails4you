        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center animate-slide-up">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed max-w-4xl mx-auto">
              Náš mobilný bar funguje kdekoľvek — v elegantnej sále, záhrade, vinici aj na strechách. Pôsobíme po celom Slovensku vrátane Bratislavy, Trnavy, Nitry, Žiliny a inde.
            </p>
          </div>
        </div>
      </div>
